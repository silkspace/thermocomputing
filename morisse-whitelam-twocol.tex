...
\title{The Criticality Engine: Online Learning in Thermodynamic Neural Computers}

\author{Alexander Morisse}
\email{alex@morisse.ai}
\affiliation{CXO, TensorML.com}

\author{Stephen Whitelam}
\email{swhitelam@lbl.gov}
\affiliation{Molecular Foundry, Lawrence Berkeley National Laboratory, Berkeley, CA 94720, USA}

\author{Isaac Tamblyn}
\email{isaac.tamblyn@uottawa.ca}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{paper_figures/architecture_schematic.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.85\textwidth]{paper_figures/trajectory_action_learning.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{paper_figures/circuit_diagrams.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{paper_figures/node_anatomy.png}
...
Equilibration & Required ($\times$2) & Not required \\
...
We implement a mass-conserving stochastic process where pixels \emph{exchange} intensity rather than receiving independent noise.
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{paper_figures/thermalization_demo.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{paper_figures/exchange_learned_J_spatial.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{paper_figures/exchange_learning_curves.png}
