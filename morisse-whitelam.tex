...
This yields closed-form gradient estimators: $\partial L/\partial b_i = \text{residual}_i / 2k_{\rm B}T$, where the residual is the mismatch between observed and model-predicted velocities.
...
We demonstrate 76\% MNIST classification accuracy after a single epoch and $>$99\% parameter recovery in 10--20 epochs---fast convergence because each trajectory directly constrains parameters rather than requiring iterative search.
